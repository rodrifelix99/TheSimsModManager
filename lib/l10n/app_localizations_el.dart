...
class LEl extends L {
  ...
  String get creationSims1PickLot =>
      'Το The Sims 1 αριθμεί τα οικόπεδα με βάση τη θέση τους στον χάρτη, οπότε ένα σπίτι πρέπει να πάρει τη θέση ενός οικοπέδου που υπάρχει ήδη - και ό,τι είναι πάνω του χάνεται. Διάλεξε εσύ το οικόπεδο: κράτα ένα αντίγραφο και μετά μετονόμασε το αρχείο στον αριθμό House εκείνου του οικοπέδου, μέσα στον φάκελο Houses.';
