...
/// The install-finding helpers moved to core when SimCity needed them;
/// re-exported so every existing importer of this file still sees them.
export '../../core/install_scan.dart';
...
abstract class DocumentsSimsAdapter extends FolderBasedGameAdapter {
  ...
  /// Every Sims game here has a save reader of its own.
  @override
...
class Sims4Adapter extends DocumentsSimsAdapter {
  ...
  @override
  Map<String, String> get knownPackNames => sims4PackNames;
...
class Sims3Adapter extends DocumentsSimsAdapter {
  ...
  @override
  Map<String, String> get knownPackNames => sims3PackNames;
...
class Sims2Adapter extends DocumentsSimsAdapter {
  ...
  @override
  Map<String, String> get knownPackNames => sims2PackNames;
...
class Sims1Adapter extends InstallFolderSimsAdapter {
  ...
  @override
  Map<String, String> get knownPackNames => sims1PackCatalog;
